...
inline void tag_invoke(ImReflect::ImInput_t, const char* label, glm::vec2& value, ImSettings& settings,
                       ImResponse& response)
{
    ...
    if (changed)
        vec2_response.changed();
    ImReflect::Detail::check_input_states(vec2_response);
}

// Tag invoke implementation for glm::vec3
inline void tag_invoke(ImReflect::ImInput_t, const char* label, glm::vec3& value, ImSettings& settings,
                       ImResponse& response)
{
    ...
    if (changed)
        vec3_response.changed();
    ImReflect::Detail::check_input_states(vec3_response);
}

// Tag invoke implementation for glm::vec4
inline void tag_invoke(ImReflect::ImInput_t, const char* label, glm::vec4& value, ImSettings& settings,
                       ImResponse& response)
{
