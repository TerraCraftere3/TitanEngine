...
namespace Titan
{
    ...
    void ImGuiLayer::OnEvent(Event& event)
    {
        ...
        dispatcher.Dispatch<MouseButtonPressedEvent>(TI_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressed));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(TI_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleased));
        dispatcher.Dispatch<MouseMovedEvent>(TI_BIND_EVENT_FN(ImGuiLayer::OnMouseMoveEvent));
        dispatcher.Dispatch<MouseScrolledEvent>(TI_BIND_EVENT_FN(ImGuiLayer::OnMouseScrollEvent));
        ...
        dispatcher.Dispatch<WindowResizeEvent>(TI_BIND_EVENT_FN(ImGuiLayer::OnWindowResize));
    }
